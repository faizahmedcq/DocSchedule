...
// Removed Link import as it's not needed for a standalone component
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 p-4">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-xl p-8 md:p-12">
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">Doctor Login</h1>
        <p className="text-center text-gray-500 mb-8">
          Welcome back! Please sign in to your doctor account.
        </p>
        ...
        <div className="mt-8 text-center text-sm">
          <p className="text-gray-600">
            ...
            {/* Replaced Link with a tag to prevent routing errors in a standalone environment */}
            <a href="/doctor-registration" className="font-medium text-blue-600 hover:text-blue-500">
              Sign up now
            </a>
          </p>
        </div>
